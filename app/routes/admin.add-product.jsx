        ...
        <form onSubmit={handleSubmit}>
          <s-section heading="Product details">
            <s-stack direction="block" gap="base">
              ...
              <div>
                <label htmlFor="add-product-category" style={{ display: "block", marginBottom: 6, fontWeight: 500, fontSize: 14 }}>Category</label>
                <select
          ...
          <s-section slot="aside" heading="Organization & pricing">
            <s-stack direction="block" gap="base">
              <div>
                <s-text type="strong" style={{ display: "block", marginBottom: 8 }}>VIN decoder</s-text>
              ...
              <div>
                <label htmlFor="add-product-status" style={{ display: "block", marginBottom: 6, fontWeight: 500, fontSize: 14 }}>Status</label>
                <select
              ...
              <div>
                <s-text type="strong" style={{ display: "block", marginBottom: 8 }}>Pricing</s-text>
                <s-text-field label="Price" value={price} onInput={(e) => setPrice(e.currentTarget?.value ?? "")} placeholder="0.00" />
                <s-text-field label="Compare at price" value={compareAtPrice} onInput={(e) => setCompareAtPrice(e.currentTarget?.value ?? "")} placeholder="0.00" style={{ marginTop: 12 }} />
                <s-text-field label="Cost per item" value={cost} onInput={(e) => setCost(e.currentTarget?.value ?? "")} placeholder="0.00" style={{ marginTop: 12 }} />
              </div>
              <div>
